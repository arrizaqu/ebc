            ...
            <nav class="navbar navbar-primary navbar-absolute">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> Master Data Materi </a>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content table-responsive">
                                    <table id="table-user" class="table table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach var="materi" items="${paginate.dataPopulate }">
                                            	<tr>
                                            		<td><c:out value="${materi.title }"></c:out></td>
                                            		<td><c:out value="${materi.programmingLanguage }"></c:out></td>
                                            		<td><c:out value="${materi.category }"></c:out></td>
                                            		<td>
                                            			<a id="${materi.id }" href="#" class="btn-hapus btn btn-danger btn-sm">Delete</a>
                                            		</td>
                                            	</tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                                    <div>${paginate.completeLinkePage }</div>
                                </div>
                            </div>
                        </div>
